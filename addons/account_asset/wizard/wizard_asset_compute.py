...
class asset_depreciation_confirmation_wizard(osv.osv_memory):
    ...
    _columns = {'period_id': fields.many2one('account.period', 'Period', required=True, help='Choose the period for which you want to automatically post the depreciation lines of running assets')}
    ...
    def asset_compute(self, cr, uid, ids, context):
        ...
        return {'name': _('Created Asset Moves'),
         'view_type': 'form',
         'view_mode': 'tree,form',
