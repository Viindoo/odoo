...
class account_analytic_profit(report_sxw.rml_parse):
    ...
    def __init__(self, cr, uid, name, context):
        ...
        self.localcontext.update({'lines': self._lines,
    ...
    def _journal_ids(self, form, user_id):
        ...
        line_ids = line_obj.search(self.cr, self.uid, [('date', '>=', form['date_from']),
         ('date', '<=', form['date_to']),
    ...
    def _line(self, form, journal_ids, user_ids):
        ...
        ids = line_obj.search(self.cr, self.uid, [('date', '>=', form['date_from']),
         ('date', '<=', form['date_to']),
