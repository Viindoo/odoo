...
class stock_fill_inventory(osv.osv_memory):
    ...
    def _default_location(self, cr, uid, ids, context = None):
        ...
        except (ValueError, orm.except_orm) as e:
            return False
    ...
    _columns = {
         ...
         'recursive': fields.boolean('Bao gồm cả vị trí con', help='If checked, products contained in child locations of selected location will be included as well.'),
    ...
    def fill_inventory(self, cr, uid, ids, context = None):
        ...
        if fill_inventory.recursive:
            location_ids = location_obj.search(cr, uid, [('location_id', 'child_of', [fill_inventory.location_id.id])], order='id', context=context)
        else:
