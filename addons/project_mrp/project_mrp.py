...
class project_task(osv.osv):
    ...
    _columns = {'procurement_id': fields.many2one('procurement.order', 'Procurement', ondelete='set null'),
...
class product_product(osv.osv):
    ...
    _columns = {'project_id': fields.many2one('project.project', 'Project', ondelete='set null')}
...
class sale_order(osv.osv):
    ...
    def _prepare_order_line_procurement(self, cr, uid, order, line, move_id, date_planned, context = None):
        proc_data = super(sale_order, self)._prepare_order_line_procurement(cr, uid, order, line, move_id, date_planned, context=context)
    ...
    _columns = {'picked_rate': fields.function(_picked_rate, method=True, string='Picked', type='float')}
