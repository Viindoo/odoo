...
class budget_report(report_sxw.rml_parse):
    ...
    def __init__(self, cr, uid, name, context):
        ...
        self.localcontext.update({'funct': self.funct,
    ...
    def funct(self, object, form, ids = None, done = None, level = 1):
        ...
        for budget_id in budgets:
            ...
            context = {'wizard_date_from': d_from,
             'wizard_date_to': d_to}
            for i in range(0, len(an_ids)):
                ...
                tot_theo = tot_pln = tot_prac = tot_perc = 0.0
                done_budget = []
                for line in line_id:
                    if line.id in budget_ids:
                        ...
                        if line.general_budget_id.id in done_budget:
                            ...
                            if theo != 0.0:
                                ...
                                perc = 0.0
                            res1 = {'a_id': line.analytic_account_id.id,
                    ...
                    elif line.general_budget_id.id in done_budget:
                        continue
                    else:
                        res1 = {'a_id': line.analytic_account_id.id,
                         'b_id': line.general_budget_id.id,
