...
class payment_order_create(osv.osv_memory):
    ...
    _columns = {'duedate': fields.date('Due Date', required=True),
     'entries': fields.many2many('account.move.line', 'line_pay_rel', 'pay_id', 'line_id', 'Entries')}
    _defaults = {'duedate': lambda *a: time.strftime('%Y-%m-%d')}
    ...
    def create_payment(self, cr, uid, ids, context = None):
        ...
        if not line_ids:
            ...
            for line in line_obj.browse(cr, uid, line_ids, context=context):
                ...
                payment_obj.create(cr, uid, {'move_line_id': line.id,
                 ...
                 'date': date_to_pay,
                 'currency': line.invoice and line.invoice.currency_id.id or line.journal_id.currency.id or line.journal_id.company_id.currency_id.id}, context=context)
