...
class make_procurement(osv.osv_memory):
    ...
    _columns = {'qty': fields.float('Quantity', digits=(16, 2), required=True),
    ...
    _defaults = {'date_planned': fields.date.context_today,
     'qty': lambda *args: 1.0}
    ...
    def make_procurement(self, cr, uid, ids, context = None):
        ...
        for proc in self.browse(cr, uid, ids, context=context):
            ...
            procure_id = procurement_obj.create(cr, uid, {'name': 'INT: ' + str(user),
