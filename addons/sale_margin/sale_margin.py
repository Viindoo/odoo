...
class sale_order_line(osv.osv):
    ...
    _columns = {'margin': fields.function(_product_margin, string='Margin', store=True),
...
class sale_order(osv.osv):
    ...
    _columns = {'margin': fields.function(_product_margin, string='Margin', help='It gives profitability by calculating the difference between the Unit Price and the cost price.', store={'sale.order.line': (_get_order, ['margin'], 20),
