...
class WebsiteSale(http.Controller):
    ...
    def _get_search_order(self, post):
        ...
        # page (142 in one production week). Fall back to the default sort
        # instead of crashing.
    ...
    def shop(self, page=0, category=None, search='', ppg=False, **post):
        ...
        if category:
            try:
                ...
                # crawlers append slashes/garbage to ?category= - not found,
                # not a 500 (60 crashes in one production week)
                raise NotFound()
