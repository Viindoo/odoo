...
class plugin_thunderbird_installer(osv.osv_memory):
    ...
    _columns = {'thunderbird': fields.boolean('Thunderbird Plug-in', help='Allows you to select an object that you would like to add to your email and its attachments.'),
