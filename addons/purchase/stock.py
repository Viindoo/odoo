...
class stock_move(osv.osv):
    _inherit = 'stock.move'
    _columns = {'purchase_line_id': fields.many2one('purchase.order.line', 'Purchase Order Line', ondelete='set null', select=True, readonly=True)}
...
class stock_picking(osv.osv):
    ...
    _columns = {'purchase_id': fields.many2one('purchase.order', 'Purchase Order', ondelete='set null', select=True)}
    _defaults = {'purchase_id': False}
    ...
    def _invoice_line_hook(self, cursor, user, move_line, invoice_line_id):
        if move_line.purchase_line_id:
            ...
            purchase_line_obj.write(cursor, user, [move_line.purchase_line_id.id], {'invoiced': True,
