...
PURCHASE_ORDER_LINE_EDI_STRUCT = {'name': True,
 'date_planned': True,
 'product_id': True,
 'product_uom': True,
 'price_unit': True,
 'product_qty': True,
 'price_subtotal': True}
PURCHASE_ORDER_EDI_STRUCT = {'company_id': True,
 'name': True,
 'partner_ref': True,
 'origin': True,
 'date_order': True,
...
class purchase_order(osv.osv, EDIMixin):
    ...
    def edi_export(self, cr, uid, records, edi_struct = None, context = None):
        ...
        for order in records:
            ...
            edi_doc.update({'__import_model': 'sale.order',
    ...
    def edi_import(self, cr, uid, edi_document, context = None):
        ...
        for order_line in edi_document['order_line']:
            ...
            if discount:
                order_line['price_unit'] = res_currency.round(cr, uid, order_currency, order_line['price_unit'] * (1 - (discount or 0.0) / 100.0))
