...
class mail_mail(osv.Model):
    ...
    _order = 'id desc'
    _columns = {'mail_message_id': fields.many2one('mail.message', 'Message', required=True, ondelete='cascade'),
    ...
    def send_get_mail_subject(self, cr, uid, mail, force = False, partner = None, context = None):
        ...
        if (force or not mail.subject) and mail.parent_id and mail.parent_id.subject:
    ...
    def send_get_mail_body(self, cr, uid, mail, partner = None, context = None):
        ...
        """
        body = mail.body_html
        if partner and partner.user_ids and mail.model and mail.res_id and self.check_access_rights(cr, partner.user_ids[0].id, 'read', raise_exception=False):
            ...
            try:
                ...
                query = {'db': cr.dbname}
                fragment = {'login': related_user.login,
                 'model': mail.model,
                 'id': mail.res_id}
    ...
    def send_get_email_dict(self, cr, uid, mail, partner = None, context = None):
        ...
        if partner and mail.record_name:
            sanitized_record_name = re.sub('[^\\w+.]+', '-', mail.record_name)
