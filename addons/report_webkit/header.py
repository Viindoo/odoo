...
class HeaderHTML(osv.osv):
    ...
    _columns = {'company_id': fields.many2one('res.company', 'Company'),
     ...
     'orientation': fields.selection([('Landscape', 'Landscape'), ('Portrait', 'Portrait')], 'Orientation'),
     'format': fields.selection([('A0', 'A0  5   841 x 1189 mm'),
                ...
                ('Tabloid', 'Tabloid 29 279.4 x 431.8 mm')], 'Paper size', required=True, help='Select Proper Paper size')}
