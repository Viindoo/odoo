...
INVOICE_LINE_EDI_STRUCT = {'name': True,
 'origin': True,
 'uos_id': True,
 'product_id': True,
 'price_unit': True,
 ...
 'discount': True,
 'price_subtotal': True}
INVOICE_TAX_LINE_EDI_STRUCT = {'name': True,
 'base': True,
 'amount': True,
 'manual': True,
 'sequence': True,
...
class account_invoice(osv.osv, EDIMixin):
    ...
    def edi_export(self, cr, uid, records, edi_struct = None, context = None):
        ...
        for invoice in records:
            ...
            edi_doc.update({'company_address': res_company.edi_export_address(cr, uid, invoice.company_id, context=context),
    ...
    def edi_import(self, cr, uid, edi_document, context = None):
        ...
        for edi_invoice_line in edi_document['invoice_line']:
            ...
            product_id = self.edi_import_relation(cr, uid, 'product.product', product_info[1], product_info[0], context=context)
