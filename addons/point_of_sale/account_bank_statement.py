...
class account_journal(osv.osv):
    ...
    _columns = {'journal_user': fields.boolean('PoS Payment Method', help='Check this box if this journal define a payment method that can be used in point of sales.'),
    ...
    _defaults = {'self_checkout_payment_method': False}
...
class account_cash_statement(osv.osv):
    ...
    _columns = {'pos_session_id': fields.many2one('pos.session')}
