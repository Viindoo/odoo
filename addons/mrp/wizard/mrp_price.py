...
class mrp_price(osv.osv_memory):
    ...
    _columns = {'number': fields.integer('Quantity', required=True, help='Specify quantity of products to produce or buy. Report of Cost structure will be displayed base on this quantity.')}
    _defaults = {'number': 1}
