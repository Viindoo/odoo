...
class account_statement_from_invoice_lines(osv.osv_memory):
    ...
    _columns = {'line_ids': fields.many2many('account.move.line', 'account_move_line_relation', 'move_id', 'line_id', 'Invoices')}
    ...
    def populate_statement(self, cr, uid, ids, context = None):
        ...
        if not statement_id:
            ...
            for line in line_obj.browse(cr, uid, line_ids, context=context):
                ...
                statement_line_obj.create(cr, uid, {'name': line.name or '?',
                 'amount': amount,
                 'type': type,
                 'partner_id': line.partner_id.id,
