...
class base_config_settings(osv.TransientModel):
    ...
    _columns = {'auth_oauth_google_enabled': fields.boolean('Allow users to sign in with Google'),
    ...
    def get_oauth_providers(self, cr, uid, fields, context = None):
        ...
        return {'auth_oauth_google_enabled': rg[0]['enabled'],
    ...
    def set_oauth_providers(self, cr, uid, ids, context = None):
        ...
        rg = {'enabled': config.auth_oauth_google_enabled,
         'client_id': config.auth_oauth_google_client_id}
        rf = {'enabled': config.auth_oauth_facebook_enabled,
