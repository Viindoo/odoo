    ...
    try:
        ...
        try:
            ...
            def get_resource_by_id_2_0_16(self, resource_id, **kwargs):
                return self.GetResourceBySelfLink((gdata.docs.client.RESOURCE_FEED_URI + '/%s' % resource_id), **kwargs)
...
class google_docs_ir_attachment(osv.osv):
    ...
    def _auth(self, cr, uid, context = None):
        ...
        user_config = google_pool.default_get(cr, uid, {'user': '',
    ...
    def create_empty_google_doc(self, cr, uid, res_model, res_id, context = None):
        ...
        self.create(cr, uid, {'res_model': res_model,
         'res_id': res_id,
         'type': 'url',
         'name': title,
         'url': gdocs_resource.get_alternate_link().href}, context=context)
    ...
    def copy_gdoc(self, cr, uid, res_model, res_id, name_gdocs, gdoc_template_id, context = None):
        ...
        self.create(cr, uid, {'res_model': res_model,
         ...
         'type': 'url',
         'name': name_gdocs,
         'url': copy_resource.get_alternate_link().href}, context=context)
...
class config(osv.osv):
    ...
    _defaults = {'name_template': 'gdoc_%(name)s'}
